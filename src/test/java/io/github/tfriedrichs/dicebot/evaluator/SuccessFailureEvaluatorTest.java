...
class SuccessFailureEvaluatorTest {
    ...
    void shouldReturnZeroForNoSuccessesAndNoFailures() {
        ...
        SuccessModifier successModifier = new SuccessModifier(new ComparisonSelector(ComparisonSelector.Mode.GREATER_EQUALS, 5));
        FailureModifier failureModifier = new FailureModifier(new ComparisonSelector(ComparisonSelector.Mode.LESSER_EQUALS, 1));
