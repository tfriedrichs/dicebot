...
class DirectionSelectorTest {
    ...
    void shouldThrowForNegativeNumberOfDiceToSelect() {
        assertThrows(IllegalArgumentException.class,
            () -> new DirectionSelector(Direction.HIGH, DropMode.SKIP, -2));
    }

    @Test
    void selectShouldSelectAllIfNumberToSelectIsGreaterThanRolls() {
        DiceRoll roll = new DiceRoll(2, 5, 1, 1, 3, 4, 6);
        DirectionSelector selector = new DirectionSelector(Direction.HIGH, DropMode.SKIP, 12);
    ...
    void selectHighShouldSelectHighest() {
        DiceRoll roll = new DiceRoll(2, 5, 1, 1, 3, 4, 6);
        DirectionSelector selector = new DirectionSelector(Direction.HIGH, DropMode.SKIP, 3);
    ...
    void selectLowShouldSelectLowest() {
        DiceRoll roll = new DiceRoll(2, 5, 1, 1, 3, 4, 6);
        DirectionSelector selector = new DirectionSelector(Direction.LOW, DropMode.SKIP, 3);
