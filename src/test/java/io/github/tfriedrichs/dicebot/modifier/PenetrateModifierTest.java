...
class PenetrateModifierTest {
    ...
    void shouldReturnIdentityIfNoPenetrations() {
        ...
        DiceRollModifier modifier = new PenetrateModifier(MAX_DEPTH, new ComparisonSelector(ComparisonSelector.Mode.GREATER_EQUALS, 5));
    ...
    void shouldPenetrateUntilMaxDepth() {
        ...
        DiceRollModifier modifier = new PenetrateModifier(100, new ComparisonSelector(ComparisonSelector.Mode.LESSER_EQUALS, 1));
